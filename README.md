[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/U8RjaSEK)
# Lab 2: Uncertainty and Monte Carlo for Simple Climate Models

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

This is the repository for Lab 2 for [BEE 4750](https://viveks.me/environmental-systems-analysis), taught at [Cornell University](https://cornell.edu) in Fall 2023 by [Vivek Srikrishnan](https://viveks.me).
...
- project climate outcomes using a simple climate model.
...
2. Opening the notebook will depend on what you decided to do in the previous step. 
  ...
  - If you want to use `IJulia.jl`, open a Julia prompt. You can do this by:
    ...
    - Navigating to your `BEE4750/labs/lab02` folder and typing `julia` to open the prompt. Then:
